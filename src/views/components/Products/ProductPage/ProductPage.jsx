...
import { MsgFullWidth, RequireLogedAlert } from '../../PopUp';
...
export default function ProductPage({ objProduct }) {
    ...
    return (
        <section className='product-page__section'>
            {
                loginRequirePopUp ?
                 <RequireLogedAlert setLoginRequirePopUp={setLoginRequirePopUp}/>
                 :
                null
            }
            {
            ...
            <div className="top-product-section__div">
                ...
                <div className='top-product-info__div'>
                    ...
                    <div onClick={() => quantity !== 0 ? addToCart() : null}>
