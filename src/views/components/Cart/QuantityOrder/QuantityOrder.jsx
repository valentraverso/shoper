...
export default function QuantityOrder({deleteMsg, cart, isRefetching, refetch}) {
            ...
            <div className="products-cart-container__div">
                {
                    cart.length === 0 ?
                        ...
                        :
                        cart?.map(({ title, img, totalPrice, id, quantity }) => {
                            return (
                                <div className='product-cart__div' key={id}>
                                    ...
                                    <div className='product-cart-options__div'>
                                        <p onClick={() => handleDelete(id, quantity)}><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
